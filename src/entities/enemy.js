...
export const ENEMY_PRESETS = {
  anchovy: {
    hp: 1, spawnVx: -90, radius: 5, fireInterval: 999,
    points: 100, dropChance: 0.1,
    drawW: 20, drawH: 10,
  },
  shrimp: {
    hp: 2, spawnVx: -55, radius: 6, fireInterval: 2.0,
    points: 200, dropChance: 0.25,
    drawW: 24, drawH: 14,
  },
  mackerel: {
    hp: 3, spawnVx: -130, radius: 8, fireInterval: 3.0,
...
export function updateEnemy(e, dt, player, enemyBulletPool) {
  ...
  if (e.x < -30 || e.y < -30 || e.y > H + 30) e.active = false;
}
